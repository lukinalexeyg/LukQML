...
Item {
    ...
    Menu {
        ...
        MenuItem {
            ...
            onTriggered: {
                ClipboardAdapter.text = internal.selectedText;
        ...
        MenuItem {
            ...
            onTriggered: {
                ClipboardAdapter.text = contextMenu.target.text;
        ...
        MenuItem {
            ...
            enabled: internal.selectedText != ""
            onTriggered: ClipboardAdapter.text = internal.selectedText;
        }
        ...
        MenuItem {
            ...
            onTriggered: ClipboardAdapter.text = contextMenu.target.text;
        }
